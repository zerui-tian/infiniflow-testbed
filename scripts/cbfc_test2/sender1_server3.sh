...
DEFAULT_EAL_PCI_ADDRS="0000:41:00.0,0000:41:00.1,0000:42:00.0"
DEFAULT_LOG_LEVEL="INFO"
DEFAULT_CSV_FILES="${ROOT_DIR}/examples/cbfc/sender1.csv,${ROOT_DIR}/examples/cbfc/sender2.csv,${ROOT_DIR}/examples/cbfc/sender3.csv"
# DEFAULT_CSV_FILES="${ROOT_DIR}/examples/flows_sgh.csv,${ROOT_DIR}/examples/flows_sgh.csv"
DEFAULT_PORT_IDS="0,1,2"
DEFAULT_NB_VC="8"
