...
int receiver_feedback_init(receiver_ctx_t *ctx) {
    ...
    ctx->feedback_ring =
        rte_ring_create("receiver_feedback_ring", ctx->cfg.feedback_ring_size, rte_socket_id(),
                        feedback_ring_flags);
    ctx->feedback_free_ring =
        rte_ring_create("receiver_feedback_free_ring", ctx->cfg.feedback_ring_size,
                        rte_socket_id(), free_ring_flags);
